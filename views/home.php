            ...
            <div class="picture-slider__wrp swiper-wrapper">
                <div class="picture-slider__item swiper-slide">
                    ...
                    <div class="picture-slider__content">
                        ...
                        <div class="picture-slider__text">Un catálogo completo de muchas películas que ver, todas las que
                ...
                <div class="picture-slider__item swiper-slide">
                    ...
                    <div class="picture-slider__content">
                        ...
                        <div class="picture-slider__text">Si ya eres parte de nuestra comunidad, solo tienes que acceder para
                ...
                <div class="picture-slider__item swiper-slide">
                    ...
                    <div class="picture-slider__content">
                        ...
                        <div class="picture-slider__text">Si aún no eres miembro, ¿qué más esperas para formar parte y
                            disfrutar de horas de entretenimiento? Hazlo ahora</div>
                        <a href="#" class="picture-slider__button">Registrarse</a>
                    </div>
                </div>
