                ...
                <div class="box-tittle">
                    <div class="box-content">
                        ...
                        <div class="btn__actions">
                            <a href="<?= BASE_DIR; ?>User/cart&id=<?= $targetId; ?>&type=1&quantity=1"><button class="btn-rent">$<?=$list["precioAlquilerPelicula"];?></button></a>
                            <a href="<?= BASE_DIR; ?>User/cart&id=<?= $targetId; ?>&type=2&quantity=1"><button class="btn-buy">$<?=$list["precioVentaPelicula"];?></button></a>
                        </div>
                    </div>
                </div>
            </div>
